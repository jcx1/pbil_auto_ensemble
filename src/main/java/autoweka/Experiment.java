...
public class Experiment extends XmlSerializable {
    ...
    // Note that this is more of a guideline, Auto-WEKA has quite a bit of slack built into to accomodate classifiers 
    // that can return partial results or ones that decide to offload training onto their evaluation phase.
    ...
    public static void main(String[] args) {
    	...
    	// JC -> chamado pelo ExperimentRunner
    	//System.out.println("Experiment  - rodando ....");
    	
    	// JC - Verificando o conteudo do args...
        ...
        for(int i = 0; i < args.length; i++) {
            if(args[i].equals("-noexit"))
                ...
                // Mostra o caminho onde serah guardado todo o experiment (FILE) xml => Auto-WEKA.experiment
                // Algo como: C:\Users\jcx2\AppData\Local\Temp\autoweka8228451117061522094\Auto-WEKA\Auto-WEKA.experiment
            }
            else if(seed == null)
                seed = args[i];
            else
        ...
        try {
        	// Recebe os parametros (31) para rodar o experimento [C:\weka-src\smac.bat, --seed, {SEED}, --validation-seed, {SEED}, --random-sample-seed, {SEED}, --scenarioFile, autoweka.scenario, 
        	// --logModel, false, --logAllProcessOutput, TRUE, --adaptiveCapping, false, --runGroupName, autoweka, --terminate-on-delete, C:\Users\jcx2\AppData\Local\Temp\autoweka7934920612419955252\Auto-WEKA\\out\runstamps\{SEED}.stamp, 
        	// --kill-runs-on-file-delete, C:\Users\jcx2\AppData\Local\Temp\autoweka7934920612419955252\Auto-WEKA\\out\runstamps\{SEED}.stamp, --algo-cutoff-time, 5.0, --transform-crashed-quality-value, 1.0E100, 
        	// --kill-run-exceeding-captime-factor, 2.0, --initialIncumbent, DEFAULT, --acq-func, EI]
            Experiment exp = Experiment.fromXML(new FileInputStream(experiment));
            
            //System.out.println("size => " + exp.callString.size());
            //System.out.println(exp.callString);
            
            // substitui a palavra {SEED} pela propria seed
            ...
            // [C:\weka-src\smac.bat, --seed, 123, --validation-seed, 123, --random-sample-seed, 123, --scenarioFile, autoweka.scenario, --logModel, false, 
            // System.out.println(exp.callString);
            ...
            // cria um novo processo para rodar o smac
            ...
            // o que tem dentro????
            // {USERDOMAIN_ROAMINGPROFILE=UKC, LOCALAPPDATA=C:\Users\jcx2\AppData\Local, PROCESSOR_LEVEL=6, USERDOMAIN=UKC, FPS_BROWSER_APP_PROFILE_STRING=Internet Explorer,
            // System.out.println("env.: " + env);
            
            //System.out.println("envVariables.: " + exp.envVariables);
            ...
            // que file eh este? - > eh criado vazio e depois eh apagado. Nao saquei!!!
            // System.out.println("stampFile.: " + stampFile);
