...
public abstract class InstanceGenerator { 
    ...
    public InstanceGenerator(String datasetString) {
        ...
        if(datasetString.equals("__dummy__")){
            ...
            // System.out.println("type.: " + type); // type = trainTestArff
            ...
            if(type == null){
            	...
            	// System.out.println("Vai entar aqui....");
            	// JC vai para a linha 153
    ...
    // Da linha 91, o fluxo vem para cah.
    private void loadTrainTestArff(String trainArff, String testArff, String classIndex) {
    	// JC 
    	// System.out.println(trainArff + " - " + testArff + " - " + classIndex);
        //Get the training data
        try {
            mTraining = Util.loadDataSource(new FileInputStream(trainArff));
            // System.out.println("Base Treinamento.: " + mTraining);
            // Base weather  - ok - classIndex = 4 [0, 1, 2, 3, 4] - cinco atributos, sendo a classe o ultimo
        ...
        if(!testArff.equals("__dummy__"))  {
        	...
        	// A base de teste fica sendo a mesma de treinamento!!!!
            mTesting = mTraining;
            // System.out.println("Base Teste.: " + mTesting);
        }
    }
