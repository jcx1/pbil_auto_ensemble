...
public class Util {
    ...
    static public void parsePropertyString(Properties props, String propStr) {
    	...
    	// System.out.println("propStr.: " + propStr.toString());
     ...
     */
    static public Instances createDummyInstances(int numInstances, int numClasses, int numUsefulNumeric, int numUsefulCategorical, 
    		int numRandomNumeric, int numRandomCategorical, int randomCategoricalSize, int seed) {
    ...
    public static String getAutoWekaDistributionPath() {
        ...
        // JC - buscou a classe Util.class dentro de C:/weka-src/bin/autoweka/
        ...
        while(dir != null){
        	// JC - pega o caminho de estao guardados os parametros
        ...
        // JC fixei o path (todo o projeto deve estar em C:\weka-src
