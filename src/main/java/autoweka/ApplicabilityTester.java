...
public class ApplicabilityTester {
    ...
    public static ApplicableClassifiers getApplicableClassifiers(Instances instances, String baseDir, List<String> allowed)  {
    	...
    	// System.out.println("Dir " + baseDir + " " + allowed);
        ...
        // JC direciona para o diretorio C:\weka-src\params\base\ onde ficam os classificadores base 
    ...
    private static List<ClassParams> getApplicable(Instances instances, String paramDirName, Testable type, 
    		List<String> allowed, List<String> options){
        ...
        // JC carrega todos os 28 + 7 + 2 classificadores e remove a extensao
        for(File i:params) {
