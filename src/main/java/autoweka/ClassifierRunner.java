...
public class ClassifierRunner{
	// JC - classe que se encarrega de rodar um classificador using o Auto-WEKA
    ...
    public ClassifierResult evaluateClassifierOnTesting(AbstractClassifier classifier, String instanceStr, 
    		String resultMetric, float evaluateClassifierOnInstances){
        ClassifierResult res = new ClassifierResult(resultMetric);
        ...
        if(!mTestOnly && ((attribSearchClassName != null && !attribSearchClassName.equals("NONE")) || (attribEvalClassName != null /*&& !attribEvalClassName.equals("NONE")*/) )){
            ...
            if(asThread.getException() != null || asThread.terminated()){
                if(asThread.getException() != null){
                    ...
                    log.warn("Attribute selection (search {} {}, eval {} {}) failed: {}", attribSearchClassName, argMap.get("attributeeval"), attribEvalClassName, 
                    		argMap.get("attributesearch"), asThread.getException().getMessage(), asThread.getException());
                }
    ...
    private boolean _evaluateClassifierOnInstances(AbstractClassifier classifier, ClassifierResult res, 
    		Instances instances, float timeout,List<String> args,String instanceStr){
    ...
    // JC - chamada depois de classificador treinado
    ...
    public static class EvaluatorThread extends WorkerThread{
        ...
        protected String getOpName(){
            return "Evaluation of classifier";    // JC mensagem sera completada com parte vinda do ClassifierResult (linha 328)
        }
    }
