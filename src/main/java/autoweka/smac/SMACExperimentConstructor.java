...
public class SMACExperimentConstructor extends ExperimentConstructor {
    ...
    public void prepareExperiment(String path) {
    	// JC -> chamado pelo ExperimentConstructor 
    ...
    public List<String> getCallString(String experimentPath) {
        ...
        // JC pega o caminho e o nome do arquivo *.bat - nesse caso -> C:\weka-src\smac.bat
        //System.out.println("SMACExperimentConstructor.java - Caminho do *.bat: " + f);
