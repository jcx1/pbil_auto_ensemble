...
public abstract class ExperimentConstructor {
   ...
   // The output path for the experiments
    ...
    public static void buildSingle(String builderClassName, Experiment exp, List<String> args) {
        ...
        // JC
        // log.debug("Making Experiment -> Chamado por AutoWekaClassifier {}", exp.name);
        Class<?> cls;
    ...
    private void run(Experiment exp, List<String> args) {
        ...
        // JC - chama o Util.class para pegar os parametros dos classificadores em C:\weka-src\params
        // e pegar o caminho principal -> C:\weka-src - para depois guardar em propsFilePath o caminho e nome do arquivo a ser aberto
        // C:\weka-src\autoweka.smac.SMACExperimentConstructor.properties - ele contem o nome do arquivo *.bat a ser executado
        String propsFilePath = Util.getAutoWekaDistributionPath() + File.separator + this.getClass().getCanonicalName() + ".properties";
        // System.out.println("ExperimentConstructor.java - propsFilePath.: " + propsFilePath);
        
        try {
        	// JC - tenta abrir o arquivo autoweka.smac.SMACExperimentConstructor.properties
        ...
        // JC mostra o tamanho da lista de classificadores
        //System.out.println("Tamanho => " + mAllowedClassifiers.size());
        //System.out.println("mAllowedClassifiers.: " + mAllowedClassifiers);
        
        // JC Limpando a lista de classificadores
        mAllowedClassifiers.clear();
        
        //System.out.println("Tamanho => " + mAllowedClassifiers.size());
        //System.out.println("mAllowedClassifiers.: " + mAllowedClassifiers);
        
        // JC inserindo apenas os que eu quero
        mAllowedClassifiers.add("weka.classifiers.bayes.BayesNet");
        mAllowedClassifiers.add("weka.classifiers.bayes.NaiveBayes");
        mAllowedClassifiers.add("weka.classifiers.functions.MultilayerPerceptron"); 
        mAllowedClassifiers.add("weka.classifiers.functions.SMO"); 
        mAllowedClassifiers.add("weka.classifiers.lazy.IBk"); 
        mAllowedClassifiers.add("weka.classifiers.lazy.KStar"); 
        mAllowedClassifiers.add("weka.classifiers.trees.J48");  
        mAllowedClassifiers.add("weka.classifiers.trees.RandomTree");
        mAllowedClassifiers.add("weka.classifiers.rules.DecisionTable"); 

        mAllowedClassifiers.add("weka.classifiers.trees.RandomForest"); 
        mAllowedClassifiers.add("weka.classifiers.meta.AdaBoostM1"); 
        mAllowedClassifiers.add("weka.classifiers.meta.Bagging"); 
        mAllowedClassifiers.add("weka.classifiers.meta.RandomCommittee"); 
        mAllowedClassifiers.add("weka.classifiers.meta.Stacking"); 
        mAllowedClassifiers.add("weka.classifiers.meta.Vote");
        
        //mAllowedClassifiers.add("weka.classifiers.trees.LMT");
        //mAllowedClassifiers.add("weka.classifiers.meta.AttributeSelectedClassifier"); 
        //mAllowedClassifiers.add("weka.classifiers.meta.RandomSubSpace"); 
    ...
    public ParameterConditionalGroup generateAlgorithmParameterConditionalGroupForDAG() {
        ...
        //System.out.println(baseClassifiers.toString());
    ...
    private void addClassifierToParameterConditionalGroupForDAG(ParameterConditionalGroup paramGroup, 
    		ClassParams clsParams, String prefix, Parameter parent) {
