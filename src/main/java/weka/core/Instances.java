...
RevisionHandler {
  ...
  public Instances testCV(int numFolds, int numFold) {
    ...
    // JC imprime a(s) instancia(s) de teste
  ...
  public Instances trainCV(int numFolds, int numFold) {
    ...
    numInstForFold = numInstances() / numFolds;
    // System.out.println("numInstForFold.: " + numInstForFold);
    ...
    // train -> 14 - 1 = 13
    // serve para configurar o dataset.m_ClassIndex; dataset.m_RelationName; dataset.m_Attributes; dataset.m_NamesToAttributeIndices; and ArrayList<Instance>(capacity);
    train = new Instances(this, numInstances() - numInstForFold);
    
    // first -> 7 * (14 / 10) + 4 +> 7 * 1 + 4 = 11
    first = numFold * (numInstances() / numFolds) + offset;
    //System.out.println("first.: " + first);
    
    // embaralhou as instâncias para formar uma base de training com mesmo numero de inst.
