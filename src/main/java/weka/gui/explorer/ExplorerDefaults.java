...
public class ExplorerDefaults implements Serializable {
  ...
  protected static Object getObject(String property, String defaultValue,
    ...
    try {
      ...
      if (tmpOptions.length != 0) {
        ...
        result = Utils.forName(cls, defaultValue, tmpOptions);
  ...
  public static String[] getTabs() {
    ...
    // inserir AutoWEKAPanel
    tabs = get(
      "Tabs",
      "weka.gui.explorer.ClassifierPanel,weka.gui.explorer.ClustererPanel,weka.gui.explorer.AssociationsPanel,weka.gui.explorer.AttributeSelectionPanel,"
      + "weka.gui.explorer.VisualizePanel,weka.gui.explorer.AutoWEKAPanel");
    result = tabs.split(",");
  ...
  public static Object getClassifier() {
    ...
    result = getObject("Classifier", weka.classifiers.meta.AutoWEKAClassifier.class.getName(), weka.classifiers.Classifier.class);
    
    
    if (result == null) {
    	result = new weka.classifiers.meta.AutoWEKAClassifier();
